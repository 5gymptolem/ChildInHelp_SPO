...
## Λειτουργία
# Αρχικοποίηση Αισθητήρα (DFRobot MAX30102)
...
# Στήσιμο του Bluetooth (BLE Server)
...
# Η Κύρια Λειτουργία (Loop)
Εδώ γίνεται η συνεχής δουλειά:
- Ζητάει από τον αισθητήρα να υπολογίσει το SpO2 και τους παλμούς.
- Ελέγχει αν η μέτρηση είναι αξιόπιστη (δηλαδή αν validHeartRate και validSPO2 είναι 1).
- Αν τα δεδομένα είναι σωστά, τα τυπώνει στη Σειριακή Οθόνη (για να τα βλέπεις στον υπολογιστή).
- Αν υπάρχει συνδεδεμένο κινητό, πακετάρει το Οξυγόνο και τους Παλμούς μαζί σε ένα πακέτο των 5 bytes και τα "σπρώχνει" (Notify) στο κινητό μέσω της υπηρεσίας Οξυγόνου (1822).
